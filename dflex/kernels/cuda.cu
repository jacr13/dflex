...
CUDA_CALLABLE float test_cuda_func(
	float var_c)
{
        //---------
    // primal vars
...
CUDA_CALLABLE void adj_test_cuda_func(
	float var_c, 
	float & adj_c,
	float & adj_ret)
{
...
CUDA_CALLABLE df::float3 triangle_closest_point_barycentric_cuda_func(
	df::float3 var_a,
	df::float3 var_b,
	df::float3 var_c,
	df::float3 var_p)
...
CUDA_CALLABLE void adj_triangle_closest_point_barycentric_cuda_func(
	df::float3 var_a,
	df::float3 var_b,
	df::float3 var_c,
	df::float3 var_p, 
...
CUDA_CALLABLE float sphere_sdf_cuda_func(
...
CUDA_CALLABLE void adj_sphere_sdf_cuda_func(
	df::float3 var_center,
	float var_radius,
	df::float3 var_p, 
...
CUDA_CALLABLE df::float3 sphere_sdf_grad_cuda_func(
	df::float3 var_center,
	float var_radius,
	df::float3 var_p)
{
...
CUDA_CALLABLE void adj_sphere_sdf_grad_cuda_func(
	df::float3 var_center,
	float var_radius,
	df::float3 var_p, 
	df::float3 & adj_center,
...
CUDA_CALLABLE float box_sdf_cuda_func(
	df::float3 var_upper,
	df::float3 var_p)
{
        //---------
...
CUDA_CALLABLE void adj_box_sdf_cuda_func(
	df::float3 var_upper,
	df::float3 var_p, 
	df::float3 & adj_upper,
	df::float3 & adj_p,
...
CUDA_CALLABLE df::float3 box_sdf_grad_cuda_func(
	df::float3 var_upper,
	df::float3 var_p)
{
        //---------
...
CUDA_CALLABLE void adj_box_sdf_grad_cuda_func(
	df::float3 var_upper,
	df::float3 var_p, 
	df::float3 & adj_upper,
	df::float3 & adj_p,
...
CUDA_CALLABLE float capsule_sdf_cuda_func(
	float var_radius,
...
CUDA_CALLABLE void adj_capsule_sdf_cuda_func(
	float var_radius,
	float var_half_width,
	df::float3 var_p, 
	float & adj_radius,
...
CUDA_CALLABLE df::float3 capsule_sdf_grad_cuda_func(
	float var_radius,
	float var_half_width,
	df::float3 var_p)
{
...
CUDA_CALLABLE void adj_capsule_sdf_grad_cuda_func(
	float var_radius,
	float var_half_width,
	df::float3 var_p, 
	float & adj_radius,
...
CUDA_CALLABLE spatial_vector spatial_transform_twist_cuda_func(
...
CUDA_CALLABLE void adj_spatial_transform_twist_cuda_func(
	spatial_transform var_t,
	spatial_vector var_x, 
...
CUDA_CALLABLE spatial_vector spatial_transform_wrench_cuda_func(
	spatial_transform var_t,
	spatial_vector var_x)
{
        //---------
...
CUDA_CALLABLE void adj_spatial_transform_wrench_cuda_func(
	spatial_transform var_t,
	spatial_vector var_x, 
	spatial_transform & adj_t,
	spatial_vector & adj_x,
...
CUDA_CALLABLE spatial_transform spatial_transform_inverse_cuda_func(
	spatial_transform var_t)
{
        //---------
    // primal vars
...
CUDA_CALLABLE void adj_spatial_transform_inverse_cuda_func(
	spatial_transform var_t, 
	spatial_transform & adj_t,
...
CUDA_CALLABLE spatial_matrix spatial_transform_inertia_cuda_func(
	spatial_transform var_t,
	spatial_matrix var_I)
{
    ...
    //---------
    // forward
    var_0 = spatial_transform_inverse_cuda_func(var_t);
...
CUDA_CALLABLE void adj_spatial_transform_inertia_cuda_func(
	spatial_transform var_t,
	spatial_matrix var_I, 
	spatial_transform & adj_t,
	...
	spatial_matrix & adj_ret)
{
    ...
    adj_spatial_transform_inverse_cuda_func(var_t, adj_t, adj_0);
    return;

}


CUDA_CALLABLE int compute_muscle_force_cuda_func(
	int var_i,
...
CUDA_CALLABLE void adj_compute_muscle_force_cuda_func(
	int var_i,
	spatial_transform* var_body_X_s,
	spatial_vector* var_body_v_s,
	int* var_muscle_links,
...
CUDA_CALLABLE spatial_transform jcalc_transform_cuda_func(
	int var_type,
	df::float3 var_axis,
	float* var_joint_q,
	int var_start)
...
CUDA_CALLABLE void adj_jcalc_transform_cuda_func(
	int var_type,
	df::float3 var_axis,
	float* var_joint_q,
	int var_start, 
...
CUDA_CALLABLE spatial_vector jcalc_motion_cuda_func(
	int var_type,
	df::float3 var_axis,
	...
	int var_joint_start)
{
    ...
    if (var_1) {
    	...
    	var_5 = spatial_transform_twist_cuda_func(var_X_sc, var_4);
    ...
    if (var_9) {
    	...
    	var_12 = spatial_transform_twist_cuda_func(var_X_sc, var_11);
    ...
    if (var_19) {
    	...
    	var_29 = spatial_transform_twist_cuda_func(var_X_sc, var_28);
    	var_30 = df::spatial_vector(var_2, var_27, var_2, var_2, var_2, var_2);
    	var_31 = spatial_transform_twist_cuda_func(var_X_sc, var_30);
    	var_32 = df::spatial_vector(var_2, var_2, var_27, var_2, var_2, var_2);
    	var_33 = spatial_transform_twist_cuda_func(var_X_sc, var_32);
...
CUDA_CALLABLE void adj_jcalc_motion_cuda_func(
	int var_type,
	df::float3 var_axis,
	spatial_transform var_X_sc,
	spatial_vector* var_joint_S_s,
	...
	spatial_vector & adj_ret)
{
    ...
    if (var_19) {
    	...
    	adj_spatial_transform_twist_cuda_func(var_X_sc, var_32, adj_X_sc, adj_32, adj_33);
    	df::adj_spatial_vector(var_2, var_2, var_27, var_2, var_2, var_2, adj_2, adj_2, adj_27, adj_2, adj_2, adj_2, adj_32);
    	adj_spatial_transform_twist_cuda_func(var_X_sc, var_30, adj_X_sc, adj_30, adj_31);
    	df::adj_spatial_vector(var_2, var_27, var_2, var_2, var_2, var_2, adj_2, adj_27, adj_2, adj_2, adj_2, adj_2, adj_30);
    	adj_spatial_transform_twist_cuda_func(var_X_sc, var_28, adj_X_sc, adj_28, adj_29);
    ...
    if (var_9) {
    	...
    	adj_spatial_transform_twist_cuda_func(var_X_sc, var_11, adj_X_sc, adj_11, adj_12);
    ...
    if (var_1) {
    	...
    	adj_spatial_transform_twist_cuda_func(var_X_sc, var_4, adj_X_sc, adj_4, adj_5);
...
CUDA_CALLABLE int jcalc_tau_cuda_func(
	int var_type,
...
CUDA_CALLABLE void adj_jcalc_tau_cuda_func(
	int var_type,
	float var_target_k_e,
	float var_target_k_d,
	float var_limit_k_e,
...
CUDA_CALLABLE int jcalc_integrate_cuda_func(
	int var_type,
	float* var_joint_q,
	float* var_joint_qd,
	float* var_joint_qdd,
...
CUDA_CALLABLE void adj_jcalc_integrate_cuda_func(
	int var_type,
	float* var_joint_q,
	float* var_joint_qd,
	float* var_joint_qdd,
...
CUDA_CALLABLE int compute_link_transform_cuda_func(
	int var_i,
	int* var_joint_type,
	...
	spatial_transform* var_body_X_sm)
{
    ...
    var_10 = jcalc_transform_cuda_func(var_6, var_7, var_joint_q, var_8);
...
CUDA_CALLABLE void adj_compute_link_transform_cuda_func(
	int var_i,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_q_start,
	...
	int & adj_ret)
{
    ...
    adj_jcalc_transform_cuda_func(var_6, var_7, var_joint_q, var_8, adj_6, adj_7, adj_joint_q, adj_8, adj_10);
...
CUDA_CALLABLE int compute_link_velocity_cuda_func(
	int var_i,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_qd_start,
	...
	spatial_vector* var_body_a_s)
{
    ...
    var_12 = jcalc_motion_cuda_func(var_0, var_1, var_11, var_joint_S_s, var_joint_qd, var_3);
    ...
    var_34 = spatial_transform_wrench_cuda_func(var_33, var_30);
    var_35 = spatial_transform_inertia_cuda_func(var_23, var_24);
...
CUDA_CALLABLE void adj_compute_link_velocity_cuda_func(
	int var_i,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_qd_start,
	...
	int & adj_ret)
{
    ...
    adj_spatial_transform_inertia_cuda_func(var_23, var_24, adj_23, adj_24, adj_35);
    adj_spatial_transform_wrench_cuda_func(var_33, var_30, adj_33, adj_30, adj_34);
    ...
    adj_jcalc_motion_cuda_func(var_0, var_1, var_11, var_joint_S_s, var_joint_qd, var_3, adj_0, adj_1, adj_11, adj_joint_S_s, adj_joint_qd, adj_3, adj_12);
...
CUDA_CALLABLE int compute_link_tau_cuda_func(
	int var_offset,
	int var_joint_end,
	int* var_joint_type,
	int* var_joint_parent,
	...
	float* var_tau)
{
    ...
    var_14 = jcalc_tau_cuda_func(var_3, var_7, var_8, var_9, var_10, var_joint_S_s, var_joint_q, var_joint_qd, var_joint_act, var_joint_target, var_joint_limit_lower, var_joint_limit_upper, var_6, var_5, var_13, var_tau);
    var_16 = (var_4 >= var_15);
    if (var_16) {
...
CUDA_CALLABLE void adj_compute_link_tau_cuda_func(
	int var_offset,
	int var_joint_end,
	int* var_joint_type,
	int* var_joint_parent,
	...
	int & adj_ret)
{
    ...
    adj_jcalc_tau_cuda_func(var_3, var_7, var_8, var_9, var_10, var_joint_S_s, var_joint_q, var_joint_qd, var_joint_act, var_joint_target, var_joint_limit_lower, var_joint_limit_upper, var_6, var_5, var_13, var_tau, adj_3, adj_7, adj_8, adj_9, adj_10, adj_joint_S_s, adj_joint_q, adj_joint_qd, adj_joint_act, adj_joint_target, adj_joint_limit_lower, adj_joint_limit_upper, adj_6, adj_5, adj_13, adj_tau, adj_14);
...
__global__ void integrate_particles_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	df::float3* var_f,
	float* var_w,
	...
	df::float3* var_v_new)
{
    ...
    //---------
    // forward
    int var_idx = blockDim.x * blockIdx.x + threadIdx.x;
    if (var_idx < dim) {
        var_0 = df::tid();
...
__global__ void integrate_particles_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	df::float3* var_f,
	float* var_w,
...
// Python entry points
void integrate_particles_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_f,
	torch::Tensor var_w,
...
{
    integrate_particles_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
...
void integrate_particles_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_f,
	torch::Tensor var_w,
...
{
    integrate_particles_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<df::float3*>(var_f),
			cast<float*>(var_w),
...
__global__ void integrate_rigids_cuda_kernel_forward(int dim, 
...
__global__ void integrate_rigids_cuda_kernel_backward(int dim, 
	df::float3* var_rigid_x,
	quat* var_rigid_r,
	df::float3* var_rigid_v,
	df::float3* var_rigid_w,
...
// Python entry points
void integrate_rigids_cuda_forward(int dim, 
...
{
    integrate_rigids_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
...
void integrate_rigids_cuda_backward(int dim, 
	torch::Tensor var_rigid_x,
	torch::Tensor var_rigid_r,
	torch::Tensor var_rigid_v,
	torch::Tensor var_rigid_w,
...
{
    integrate_rigids_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_rigid_x),
			cast<quat*>(var_rigid_r),
			cast<df::float3*>(var_rigid_v),
			cast<df::float3*>(var_rigid_w),
...
__global__ void eval_springs_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
...
__global__ void eval_springs_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_spring_indices,
	float* var_spring_rest_lengths,
...
// Python entry points
void eval_springs_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	...
	torch::Tensor var_f)
{
    eval_springs_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
...
void eval_springs_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_spring_indices,
	torch::Tensor var_spring_rest_lengths,
	...
	torch::Tensor adj_f)
{
    eval_springs_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_spring_indices),
			cast<float*>(var_spring_rest_lengths),
...
__global__ void eval_triangles_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	mat22* var_pose,
...
__global__ void eval_triangles_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	mat22* var_pose,
...
// Python entry points
void eval_triangles_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	...
	torch::Tensor var_f)
{
    eval_triangles_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
...
void eval_triangles_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	torch::Tensor var_pose,
	...
	torch::Tensor adj_f)
{
    eval_triangles_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
			cast<mat22*>(var_pose),
...
__global__ void eval_triangles_contact_cuda_kernel_forward(int dim, 
	...
	df::float3* var_f)
{
    ...
    if (var_idx < dim) {
        ...
        var_24 = triangle_closest_point_barycentric_cuda_func(var_21, var_22, var_23, var_3);
...
__global__ void eval_triangles_contact_cuda_kernel_backward(int dim, 
	int var_num_particles,
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	...
	df::float3* adj_f)
{
    ...
    if (var_idx < dim) {
        ...
        adj_triangle_closest_point_barycentric_cuda_func(var_21, var_22, var_23, var_3, adj_21, adj_22, adj_23, adj_3, adj_24);
...
// Python entry points
void eval_triangles_contact_cuda_forward(int dim, 
	int var_num_particles,
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	...
	torch::Tensor var_f)
{
    eval_triangles_contact_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_num_particles,
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
...
void eval_triangles_contact_cuda_backward(int dim, 
	int var_num_particles,
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	...
	torch::Tensor adj_f)
{
    eval_triangles_contact_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_num_particles,
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
...
__global__ void eval_triangles_rigid_contacts_cuda_kernel_forward(int dim, 
	int var_num_particles,
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	...
	df::float3* var_tri_f)
{
    ...
    if (var_idx < dim) {
        ...
        var_51 = triangle_closest_point_barycentric_cuda_func(var_45, var_46, var_47, var_33);
...
__global__ void eval_triangles_rigid_contacts_cuda_kernel_backward(int dim, 
	int var_num_particles,
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	...
	df::float3* adj_tri_f)
{
    ...
    if (var_idx < dim) {
        ...
        adj_triangle_closest_point_barycentric_cuda_func(var_45, var_46, var_47, var_33, adj_45, adj_46, adj_47, adj_33, adj_51);
...
// Python entry points
void eval_triangles_rigid_contacts_cuda_forward(int dim, 
	int var_num_particles,
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
...
{
    eval_triangles_rigid_contacts_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_num_particles,
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
...
void eval_triangles_rigid_contacts_cuda_backward(int dim, 
	int var_num_particles,
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
...
{
    eval_triangles_rigid_contacts_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_num_particles,
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
...
__global__ void eval_bending_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	float* var_rest,
...
__global__ void eval_bending_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	float* var_rest,
...
// Python entry points
void eval_bending_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	...
	torch::Tensor var_f)
{
    eval_bending_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
			cast<float*>(var_rest),
...
void eval_bending_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	torch::Tensor var_rest,
	...
	torch::Tensor adj_f)
{
    eval_bending_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
			cast<float*>(var_rest),
...
__global__ void eval_tetrahedra_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	mat33* var_pose,
...
__global__ void eval_tetrahedra_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	int* var_indices,
	mat33* var_pose,
...
// Python entry points
void eval_tetrahedra_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	torch::Tensor var_pose,
	...
	torch::Tensor var_f)
{
    eval_tetrahedra_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
			cast<mat33*>(var_pose),
...
void eval_tetrahedra_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_indices,
	torch::Tensor var_pose,
	...
	torch::Tensor adj_f)
{
    eval_tetrahedra_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<int*>(var_indices),
			cast<mat33*>(var_pose),
...
__global__ void eval_contacts_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float var_ke,
	float var_kd,
...
__global__ void eval_contacts_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float var_ke,
	float var_kd,
...
// Python entry points
void eval_contacts_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	float var_ke,
	float var_kd,
	...
	torch::Tensor var_f)
{
    eval_contacts_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			var_ke,
			var_kd,
...
void eval_contacts_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	float var_ke,
	float var_kd,
	...
	torch::Tensor adj_f)
{
    eval_contacts_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			var_ke,
			var_kd,
...
__global__ void eval_soft_contacts_cuda_kernel_forward(int dim, 
	int var_num_particles,
	...
	spatial_vector* var_body_f)
{
    ...
    if (var_idx < dim) {
        ...
        var_13 = spatial_transform_inverse_cuda_func(var_12);
        ...
        if (var_33) {
        	var_34 = box_sdf_cuda_func(var_16, var_14);
        	var_35 = df::sub(var_34, var_17);
        	var_36 = df::min(var_35, var_18);
        	var_37 = box_sdf_grad_cuda_func(var_16, var_14);
...
__global__ void eval_soft_contacts_cuda_kernel_backward(int dim, 
	int var_num_particles,
	df::float3* var_particle_x,
	df::float3* var_particle_v,
	spatial_transform* var_body_X_sc,
	...
	spatial_vector* adj_body_f)
{
    ...
    if (var_idx < dim) {
        ...
        if (var_42) {
        	...
        	adj_capsule_sdf_grad_cuda_func(var_48, var_49, var_14, adj_48, adj_49, adj_14, adj_50);
        	...
        	adj_capsule_sdf_cuda_func(var_43, var_44, var_14, adj_43, adj_44, adj_14, adj_45);
        ...
        if (var_33) {
        	...
        	adj_box_sdf_grad_cuda_func(var_16, var_14, adj_16, adj_14, adj_37);
        	df::adj_min(var_35, var_18, adj_35, adj_18, adj_36);
        	df::adj_sub(var_34, var_17, adj_34, adj_17, adj_35);
        	adj_box_sdf_cuda_func(var_16, var_14, adj_16, adj_14, adj_34);
        }
        ...
        if (var_20) {
        	...
        	adj_sphere_sdf_grad_cuda_func(var_26, var_27, var_14, adj_26, adj_27, adj_14, adj_28);
        	...
        	adj_sphere_sdf_cuda_func(var_21, var_22, var_14, adj_21, adj_22, adj_14, adj_23);
        ...
        adj_spatial_transform_inverse_cuda_func(var_12, adj_12, adj_13);
...
// Python entry points
void eval_soft_contacts_cuda_forward(int dim, 
	int var_num_particles,
...
{
    eval_soft_contacts_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_num_particles,
...
void eval_soft_contacts_cuda_backward(int dim, 
	int var_num_particles,
	torch::Tensor var_particle_x,
	torch::Tensor var_particle_v,
	torch::Tensor var_body_X_sc,
...
{
    eval_soft_contacts_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_num_particles,
			cast<df::float3*>(var_particle_x),
			cast<df::float3*>(var_particle_v),
			cast<spatial_transform*>(var_body_X_sc),
...
__global__ void eval_rigid_contacts_cuda_kernel_forward(int dim, 
	df::float3* var_rigid_x,
	quat* var_rigid_r,
	df::float3* var_rigid_v,
	df::float3* var_rigid_w,
...
__global__ void eval_rigid_contacts_cuda_kernel_backward(int dim, 
	df::float3* var_rigid_x,
	quat* var_rigid_r,
	df::float3* var_rigid_v,
	df::float3* var_rigid_w,
...
// Python entry points
void eval_rigid_contacts_cuda_forward(int dim, 
	torch::Tensor var_rigid_x,
	torch::Tensor var_rigid_r,
	torch::Tensor var_rigid_v,
	torch::Tensor var_rigid_w,
	...
	torch::Tensor var_rigid_t)
{
    eval_rigid_contacts_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_rigid_x),
			cast<quat*>(var_rigid_r),
			cast<df::float3*>(var_rigid_v),
			cast<df::float3*>(var_rigid_w),
...
void eval_rigid_contacts_cuda_backward(int dim, 
	torch::Tensor var_rigid_x,
	torch::Tensor var_rigid_r,
	torch::Tensor var_rigid_v,
	torch::Tensor var_rigid_w,
	...
	torch::Tensor adj_rigid_t)
{
    eval_rigid_contacts_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_rigid_x),
			cast<quat*>(var_rigid_r),
			cast<df::float3*>(var_rigid_v),
			cast<df::float3*>(var_rigid_w),
...
__global__ void eval_rigid_contacts_art_cuda_kernel_forward(int dim, 
	spatial_transform* var_body_X_s,
	spatial_vector* var_body_v_s,
	int* var_contact_body,
	df::float3* var_contact_point,
	...
	float* var_contact_count)
{
    ...
    if (var_idx < dim) {
        ...
        df::atomic_add(var_contact_count, var_1, var_25);
        
    }

}

__global__ void eval_rigid_contacts_art_cuda_kernel_backward(int dim, 
	spatial_transform* var_body_X_s,
	spatial_vector* var_body_v_s,
	int* var_contact_body,
	df::float3* var_contact_point,
	...
	float* adj_contact_count)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        df::adj_atomic_add(var_contact_count, var_1, var_25, adj_contact_count, adj_1, adj_25);
...
// Python entry points
void eval_rigid_contacts_art_cuda_forward(int dim, 
	...
	torch::Tensor var_contact_count)
{
    eval_rigid_contacts_art_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			...
			cast<float*>(var_contact_count));

    //check_cuda(cudaPeekAtLastError());
    //check_cuda(cudaDeviceSynchronize());
}

void eval_rigid_contacts_art_cuda_backward(int dim, 
	torch::Tensor var_body_X_s,
	torch::Tensor var_body_v_s,
	torch::Tensor var_contact_body,
	torch::Tensor var_contact_point,
	...
	torch::Tensor adj_contact_count)
{
    eval_rigid_contacts_art_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<spatial_transform*>(var_body_X_s),
			cast<spatial_vector*>(var_body_v_s),
			cast<int*>(var_contact_body),
			cast<df::float3*>(var_contact_point),
...
__global__ void eval_muscles_cuda_kernel_forward(int dim, 
	spatial_transform* var_body_X_s,
	spatial_vector* var_body_v_s,
	...
	spatial_vector* var_body_f_s)
{
    ...
    if (var_idx < dim) {
        ...
        for (var_7=var_1; var_7 < var_5; ++var_7) {
        	var_8 = compute_muscle_force_cuda_func(var_7, var_body_X_s, var_body_v_s, var_muscle_links, var_muscle_points, var_6, var_body_f_s);
        }
...
__global__ void eval_muscles_cuda_kernel_backward(int dim, 
	spatial_transform* var_body_X_s,
	spatial_vector* var_body_v_s,
	int* var_muscle_start,
	float* var_muscle_params,
	...
	spatial_vector* adj_body_f_s)
{
    ...
    if (var_idx < dim) {
        ...
        for (var_7=var_5-1; var_7 >= var_1; --var_7) {
        	adj_compute_muscle_force_cuda_func(var_7, var_body_X_s, var_body_v_s, var_muscle_links, var_muscle_points, var_6, var_body_f_s, adj_7, adj_body_X_s, adj_body_v_s, adj_muscle_links, adj_muscle_points, adj_6, adj_body_f_s, adj_8);
        }
...
// Python entry points
void eval_muscles_cuda_forward(int dim, 
	torch::Tensor var_body_X_s,
	torch::Tensor var_body_v_s,
	...
	torch::Tensor var_body_f_s)
{
    eval_muscles_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<spatial_transform*>(var_body_X_s),
			cast<spatial_vector*>(var_body_v_s),
...
void eval_muscles_cuda_backward(int dim, 
	torch::Tensor var_body_X_s,
	torch::Tensor var_body_v_s,
	torch::Tensor var_muscle_start,
	torch::Tensor var_muscle_params,
	...
	torch::Tensor adj_body_f_s)
{
    eval_muscles_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<spatial_transform*>(var_body_X_s),
			cast<spatial_vector*>(var_body_v_s),
			cast<int*>(var_muscle_start),
			cast<float*>(var_muscle_params),
...
__global__ void eval_rigid_fk_cuda_kernel_forward(int dim, 
	...
	spatial_transform* var_body_X_sm)
{
    ...
    if (var_idx < dim) {
        ...
        for (var_5=var_1; var_5 < var_4; ++var_5) {
        	var_6 = compute_link_transform_cuda_func(var_5, var_joint_type, var_joint_parent, var_joint_q_start, var_joint_qd_start, var_joint_q, var_joint_X_pj, var_joint_X_cm, var_joint_axis, var_body_X_sc, var_body_X_sm);
        }
...
__global__ void eval_rigid_fk_cuda_kernel_backward(int dim, 
	int* var_articulation_start,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_q_start,
...
// Python entry points
void eval_rigid_fk_cuda_forward(int dim, 
...
{
    eval_rigid_fk_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
...
void eval_rigid_fk_cuda_backward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_parent,
	torch::Tensor var_joint_q_start,
...
{
    eval_rigid_fk_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_parent),
			cast<int*>(var_joint_q_start),
...
__global__ void eval_rigid_id_cuda_kernel_forward(int dim, 
	int* var_articulation_start,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_q_start,
	...
	spatial_vector* var_body_a_s)
{
    ...
    if (var_idx < dim) {
        ...
        for (var_6=var_1; var_6 < var_4; ++var_6) {
        	var_7 = compute_link_velocity_cuda_func(var_6, var_joint_type, var_joint_parent, var_joint_qd_start, var_joint_qd, var_joint_axis, var_body_I_m, var_body_X_sc, var_body_X_sm, var_joint_X_pj, var_gravity, var_joint_S_s, var_body_I_s, var_body_v_s, var_body_f_s, var_body_a_s);
        }
...
__global__ void eval_rigid_id_cuda_kernel_backward(int dim, 
	int* var_articulation_start,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_q_start,
	...
	spatial_vector* adj_body_a_s)
{
    ...
    if (var_idx < dim) {
        ...
        for (var_6=var_4-1; var_6 >= var_1; --var_6) {
        	adj_compute_link_velocity_cuda_func(var_6, var_joint_type, var_joint_parent, var_joint_qd_start, var_joint_qd, var_joint_axis, var_body_I_m, var_body_X_sc, var_body_X_sm, var_joint_X_pj, var_gravity, var_joint_S_s, var_body_I_s, var_body_v_s, var_body_f_s, var_body_a_s, adj_6, adj_joint_type, adj_joint_parent, adj_joint_qd_start, adj_joint_qd, adj_joint_axis, adj_body_I_m, adj_body_X_sc, adj_body_X_sm, adj_joint_X_pj, adj_gravity, adj_joint_S_s, adj_body_I_s, adj_body_v_s, adj_body_f_s, adj_body_a_s, adj_7);
        }
...
// Python entry points
void eval_rigid_id_cuda_forward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_parent,
	torch::Tensor var_joint_q_start,
...
{
    eval_rigid_id_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_parent),
			cast<int*>(var_joint_q_start),
...
void eval_rigid_id_cuda_backward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_parent,
	torch::Tensor var_joint_q_start,
...
{
    eval_rigid_id_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_parent),
			cast<int*>(var_joint_q_start),
...
__global__ void eval_rigid_tau_cuda_kernel_forward(int dim, 
	int* var_articulation_start,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_q_start,
	...
	float* var_tau)
{
    ...
    if (var_idx < dim) {
        ...
        for (var_7=var_6; var_7 < var_5; ++var_7) {
        	var_8 = compute_link_tau_cuda_func(var_7, var_4, var_joint_type, var_joint_parent, var_joint_q_start, var_joint_qd_start, var_joint_q, var_joint_qd, var_joint_act, var_joint_target, var_joint_target_ke, var_joint_target_kd, var_joint_limit_lower, var_joint_limit_upper, var_joint_limit_ke, var_joint_limit_kd, var_joint_S_s, var_body_fb_s, var_body_ft_s, var_tau);
        }
...
__global__ void eval_rigid_tau_cuda_kernel_backward(int dim, 
	int* var_articulation_start,
	int* var_joint_type,
	int* var_joint_parent,
	int* var_joint_q_start,
...
// Python entry points
void eval_rigid_tau_cuda_forward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_parent,
	torch::Tensor var_joint_q_start,
...
{
    eval_rigid_tau_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_parent),
			cast<int*>(var_joint_q_start),
...
void eval_rigid_tau_cuda_backward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_parent,
	torch::Tensor var_joint_q_start,
...
{
    eval_rigid_tau_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_parent),
			cast<int*>(var_joint_q_start),
...
__global__ void eval_rigid_jacobian_cuda_kernel_forward(int dim, 
	int* var_articulation_start,
...
__global__ void eval_rigid_jacobian_cuda_kernel_backward(int dim, 
	int* var_articulation_start,
	int* var_articulation_J_start,
	int* var_joint_parent,
	int* var_joint_qd_start,
...
// Python entry points
void eval_rigid_jacobian_cuda_forward(int dim, 
	torch::Tensor var_articulation_start,
	...
	torch::Tensor var_J)
{
    eval_rigid_jacobian_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
...
void eval_rigid_jacobian_cuda_backward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_articulation_J_start,
	torch::Tensor var_joint_parent,
	torch::Tensor var_joint_qd_start,
	...
	torch::Tensor adj_J)
{
    eval_rigid_jacobian_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_articulation_J_start),
			cast<int*>(var_joint_parent),
			cast<int*>(var_joint_qd_start),
...
__global__ void eval_rigid_mass_cuda_kernel_forward(int dim, 
	int* var_articulation_start,
...
__global__ void eval_rigid_mass_cuda_kernel_backward(int dim, 
	int* var_articulation_start,
	int* var_articulation_M_start,
	spatial_matrix* var_body_I_s,
	float* var_M, 
...
// Python entry points
void eval_rigid_mass_cuda_forward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_articulation_M_start,
	torch::Tensor var_body_I_s,
	torch::Tensor var_M)
{
    eval_rigid_mass_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
...
void eval_rigid_mass_cuda_backward(int dim, 
	torch::Tensor var_articulation_start,
	torch::Tensor var_articulation_M_start,
	torch::Tensor var_body_I_s,
	torch::Tensor var_M, 
	...
	torch::Tensor adj_M)
{
    eval_rigid_mass_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_articulation_start),
			cast<int*>(var_articulation_M_start),
			cast<spatial_matrix*>(var_body_I_s),
			cast<float*>(var_M), 
...
__global__ void eval_dense_gemm_cuda_kernel_forward(int dim, 
	int var_m,
	int var_n,
	int var_p,
	int var_t1,
...
__global__ void eval_dense_gemm_cuda_kernel_backward(int dim, 
	int var_m,
	int var_n,
	int var_p,
	int var_t1,
...
// Python entry points
void eval_dense_gemm_cuda_forward(int dim, 
	int var_m,
	int var_n,
	int var_p,
	int var_t1,
	...
	torch::Tensor var_C)
{
    eval_dense_gemm_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_m,
			var_n,
			var_p,
			var_t1,
...
void eval_dense_gemm_cuda_backward(int dim, 
	int var_m,
	int var_n,
	int var_p,
	int var_t1,
	...
	torch::Tensor adj_C)
{
    eval_dense_gemm_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_m,
			var_n,
			var_p,
			var_t1,
...
__global__ void eval_dense_gemm_batched_cuda_kernel_forward(int dim, 
	int* var_m,
	int* var_n,
	int* var_p,
	int var_t1,
...
__global__ void eval_dense_gemm_batched_cuda_kernel_backward(int dim, 
	int* var_m,
	int* var_n,
	int* var_p,
	int var_t1,
...
// Python entry points
void eval_dense_gemm_batched_cuda_forward(int dim, 
	torch::Tensor var_m,
	torch::Tensor var_n,
	torch::Tensor var_p,
	int var_t1,
	...
	torch::Tensor var_C)
{
    eval_dense_gemm_batched_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_m),
			cast<int*>(var_n),
			cast<int*>(var_p),
			var_t1,
...
void eval_dense_gemm_batched_cuda_backward(int dim, 
	torch::Tensor var_m,
	torch::Tensor var_n,
	torch::Tensor var_p,
	int var_t1,
	...
	torch::Tensor adj_C)
{
    eval_dense_gemm_batched_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_m),
			cast<int*>(var_n),
			cast<int*>(var_p),
			var_t1,
...
__global__ void eval_dense_cholesky_cuda_kernel_forward(int dim, 
	int var_n,
	float* var_A,
...
__global__ void eval_dense_cholesky_cuda_kernel_backward(int dim, 
	int var_n,
	float* var_A,
	float* var_regularization,
	float* var_L, 
...
// Python entry points
void eval_dense_cholesky_cuda_forward(int dim, 
	int var_n,
	torch::Tensor var_A,
	torch::Tensor var_regularization,
	torch::Tensor var_L)
{
    eval_dense_cholesky_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_n,
			cast<float*>(var_A),
...
void eval_dense_cholesky_cuda_backward(int dim, 
	int var_n,
	torch::Tensor var_A,
	torch::Tensor var_regularization,
	torch::Tensor var_L, 
	...
	torch::Tensor adj_L)
{
    eval_dense_cholesky_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_n,
			cast<float*>(var_A),
			cast<float*>(var_regularization),
			cast<float*>(var_L), 
...
__global__ void eval_dense_cholesky_batched_cuda_kernel_forward(int dim, 
	int* var_A_start,
	int* var_A_dim,
	float* var_A,
	float* var_regularization,
...
__global__ void eval_dense_cholesky_batched_cuda_kernel_backward(int dim, 
	int* var_A_start,
	int* var_A_dim,
	float* var_A,
	float* var_regularization,
...
// Python entry points
void eval_dense_cholesky_batched_cuda_forward(int dim, 
	torch::Tensor var_A_start,
	...
	torch::Tensor var_L)
{
    eval_dense_cholesky_batched_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_A_start),
			cast<int*>(var_A_dim),
			cast<float*>(var_A),
			cast<float*>(var_regularization),
...
void eval_dense_cholesky_batched_cuda_backward(int dim, 
	torch::Tensor var_A_start,
	torch::Tensor var_A_dim,
	torch::Tensor var_A,
	torch::Tensor var_regularization,
	...
	torch::Tensor adj_L)
{
    eval_dense_cholesky_batched_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_A_start),
			cast<int*>(var_A_dim),
			cast<float*>(var_A),
			cast<float*>(var_regularization),
...
__global__ void eval_dense_subs_cuda_kernel_forward(int dim, 
	int var_n,
	float* var_L,
	float* var_b,
	float* var_x)
...
__global__ void eval_dense_subs_cuda_kernel_backward(int dim, 
	int var_n,
	float* var_L,
	float* var_b,
	float* var_x, 
...
// Python entry points
void eval_dense_subs_cuda_forward(int dim, 
	int var_n,
	torch::Tensor var_L,
	torch::Tensor var_b,
	torch::Tensor var_x)
{
    eval_dense_subs_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_n,
			cast<float*>(var_L),
			cast<float*>(var_b),
			cast<float*>(var_x));
...
void eval_dense_subs_cuda_backward(int dim, 
	int var_n,
	torch::Tensor var_L,
	torch::Tensor var_b,
	torch::Tensor var_x, 
	...
	torch::Tensor adj_x)
{
    eval_dense_subs_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_n,
			cast<float*>(var_L),
			cast<float*>(var_b),
			cast<float*>(var_x), 
...
__global__ void eval_dense_solve_cuda_kernel_forward(int dim, 
	int var_n,
	float* var_A,
	float* var_L,
	float* var_b,
...
__global__ void eval_dense_solve_cuda_kernel_backward(int dim, 
	int var_n,
	float* var_A,
	float* var_L,
	float* var_b,
...
// Python entry points
void eval_dense_solve_cuda_forward(int dim, 
	int var_n,
	torch::Tensor var_A,
	torch::Tensor var_L,
	torch::Tensor var_b,
	...
	torch::Tensor var_x)
{
    eval_dense_solve_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_n,
			cast<float*>(var_A),
			cast<float*>(var_L),
			cast<float*>(var_b),
...
void eval_dense_solve_cuda_backward(int dim, 
	int var_n,
	torch::Tensor var_A,
	torch::Tensor var_L,
	torch::Tensor var_b,
	...
	torch::Tensor adj_x)
{
    eval_dense_solve_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			var_n,
			cast<float*>(var_A),
			cast<float*>(var_L),
			cast<float*>(var_b),
...
__global__ void eval_dense_solve_batched_cuda_kernel_forward(int dim, 
	int* var_b_start,
	int* var_A_start,
	int* var_A_dim,
	float* var_A,
...
__global__ void eval_dense_solve_batched_cuda_kernel_backward(int dim, 
	int* var_b_start,
	int* var_A_start,
	int* var_A_dim,
	float* var_A,
...
// Python entry points
void eval_dense_solve_batched_cuda_forward(int dim, 
	torch::Tensor var_b_start,
	torch::Tensor var_A_start,
	torch::Tensor var_A_dim,
	torch::Tensor var_A,
	...
	torch::Tensor var_x)
{
    eval_dense_solve_batched_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_b_start),
			cast<int*>(var_A_start),
			cast<int*>(var_A_dim),
			cast<float*>(var_A),
...
void eval_dense_solve_batched_cuda_backward(int dim, 
	torch::Tensor var_b_start,
	torch::Tensor var_A_start,
	torch::Tensor var_A_dim,
	torch::Tensor var_A,
	...
	torch::Tensor adj_x)
{
    eval_dense_solve_batched_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_b_start),
			cast<int*>(var_A_start),
			cast<int*>(var_A_dim),
			cast<float*>(var_A),
...
__global__ void eval_rigid_integrate_cuda_kernel_forward(int dim, 
	int* var_joint_type,
	int* var_joint_q_start,
	int* var_joint_qd_start,
	float* var_joint_q,
	...
	float* var_joint_qd_new)
{
    ...
    if (var_idx < dim) {
        ...
        var_4 = jcalc_integrate_cuda_func(var_1, var_joint_q, var_joint_qd, var_joint_qdd, var_2, var_3, var_dt, var_joint_q_new, var_joint_qd_new);
        
    }

}

__global__ void eval_rigid_integrate_cuda_kernel_backward(int dim, 
	int* var_joint_type,
	int* var_joint_q_start,
	int* var_joint_qd_start,
	float* var_joint_q,
	...
	float* adj_joint_qd_new)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        adj_jcalc_integrate_cuda_func(var_1, var_joint_q, var_joint_qd, var_joint_qdd, var_2, var_3, var_dt, var_joint_q_new, var_joint_qd_new, adj_1, adj_joint_q, adj_joint_qd, adj_joint_qdd, adj_2, adj_3, adj_dt, adj_joint_q_new, adj_joint_qd_new, adj_4);
...
// Python entry points
void eval_rigid_integrate_cuda_forward(int dim, 
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_q_start,
	torch::Tensor var_joint_qd_start,
	torch::Tensor var_joint_q,
...
{
    eval_rigid_integrate_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_q_start),
			cast<int*>(var_joint_qd_start),
			cast<float*>(var_joint_q),
...
void eval_rigid_integrate_cuda_backward(int dim, 
	torch::Tensor var_joint_type,
	torch::Tensor var_joint_q_start,
	torch::Tensor var_joint_qd_start,
	torch::Tensor var_joint_q,
...
{
    eval_rigid_integrate_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<int*>(var_joint_type),
			cast<int*>(var_joint_q_start),
			cast<int*>(var_joint_qd_start),
			cast<float*>(var_joint_q),
...
__global__ void solve_springs_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float* var_invmass,
	int* var_spring_indices,
...
__global__ void solve_springs_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float* var_invmass,
	int* var_spring_indices,
...
// Python entry points
void solve_springs_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
...
{
    solve_springs_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
...
void solve_springs_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_invmass,
	torch::Tensor var_spring_indices,
...
{
    solve_springs_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<float*>(var_invmass),
			cast<int*>(var_spring_indices),
...
__global__ void solve_tetrahedra_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float* var_inv_mass,
	int* var_indices,
...
__global__ void solve_tetrahedra_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float* var_inv_mass,
	int* var_indices,
...
// Python entry points
void solve_tetrahedra_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	...
	torch::Tensor var_delta)
{
    solve_tetrahedra_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
...
void solve_tetrahedra_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_inv_mass,
	torch::Tensor var_indices,
	...
	torch::Tensor adj_delta)
{
    solve_tetrahedra_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<float*>(var_inv_mass),
			cast<int*>(var_indices),
...
__global__ void solve_contacts_cuda_kernel_forward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float* var_inv_mass,
	float var_mu,
...
__global__ void solve_contacts_cuda_kernel_backward(int dim, 
	df::float3* var_x,
	df::float3* var_v,
	float* var_inv_mass,
	float var_mu,
...
// Python entry points
void solve_contacts_cuda_forward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_inv_mass,
	float var_mu,
	...
	torch::Tensor var_delta)
{
    solve_contacts_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<float*>(var_inv_mass),
			var_mu,
...
void solve_contacts_cuda_backward(int dim, 
	torch::Tensor var_x,
	torch::Tensor var_v,
	torch::Tensor var_inv_mass,
	float var_mu,
	...
	torch::Tensor adj_delta)
{
    solve_contacts_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x),
			cast<df::float3*>(var_v),
			cast<float*>(var_inv_mass),
			var_mu,
...
__global__ void apply_deltas_cuda_kernel_forward(int dim, 
...
__global__ void apply_deltas_cuda_kernel_backward(int dim, 
	df::float3* var_x_orig,
	df::float3* var_v_orig,
	df::float3* var_x_pred,
	df::float3* var_delta,
...
// Python entry points
void apply_deltas_cuda_forward(int dim, 
...
{
    apply_deltas_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
...
void apply_deltas_cuda_backward(int dim, 
	torch::Tensor var_x_orig,
	torch::Tensor var_v_orig,
	torch::Tensor var_x_pred,
	torch::Tensor var_delta,
...
{
    apply_deltas_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_x_orig),
			cast<df::float3*>(var_v_orig),
			cast<df::float3*>(var_x_pred),
			cast<df::float3*>(var_delta),
